...
Create a new remote repository on GitHub online called "rock-paper-scissors-exercise." Then, "clone" or download your remote copy onto your local computer. Choose a familiar location like Desktop. 

After this process is complete, you should be able to view the repo on GitHub at an address like http://github.com/YOUR_USERNAME/rock-paper-scissors-exercise. 
